...
public class BalloonRunner {
    ...
    //Hardcoded constants
    private final static String FRAGMENT_ID="net.bioclipse.balloon.win32";
    private final static String osarch="WINDOWS";
...
//            fragmentBase="hardcoded/path/to/ballon_macosx/";
            fragmentBase="/Users/ola/bin/balloon/balloon_win32/";
        }
